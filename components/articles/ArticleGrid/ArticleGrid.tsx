...
const articles: Article[] = [
  {
    ...
    date: "Nov 2023",
    thumbnail: "https://miro.medium.com/v2/resize:fit:1400/1*WoRDEq1iZnwB7-kR1iby9Q.png",
  ...
  },
  {
    ...
    date: "Sep 2023",
    thumbnail: "https://miro.medium.com/v2/resize:fit:1400/1*UTU76YgLWFYZcInI1beFWA.png",
  ...
  },
  {
    ...
    date: "Jul 2023",
    thumbnail: "https://miro.medium.com/v2/resize:fit:1400/1*fRGOGU7rgG40ipTFxxaaDA.png",
    href: "https://medium.com/design-bootcamp/crazy-8s-design-thinking-c613a1fde033",
  },
  {
    id: "04",
    title: "Design System: Colors, Variables & Styles",
    summary:
      "A comprehensive guide to structuring colors, Figma variables, and styles within a design system — covering semantic layering, naming conventions, and how to bridge the gap between design and development for scalable, theme-ready products.",
    tags: ["Design Systems", "Figma"],
    date: "May 2023",
    thumbnail: "https://miro.medium.com/v2/resize:fit:1400/1*hEy3dIwPjSX3bHTttRmCQQ.png",
    href: "https://medium.com/design-bootcamp/design-system-color-variables-and-styles-afb6c8583126",
  },
];
      ...
      >
        <div className={styles.thumbnail}>
          ...
          <img
            ...
            loading={article.id === "01" ? "eager" : "lazy"}
          />
